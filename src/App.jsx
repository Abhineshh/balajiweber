...
function App() {
  ...
  return (
    <div className='min-h-screen flex flex-col bg-red-500 font-protest'>
      ...
      <a href="#" target="_blank" className=" fixed text-stone-900 bottom-0 right-0 m-16 md:m-16 p-3 bg-stone-100 border-stone-500 border-2 text-center rounded-xl">
       <div className="flex">
