  ...
  return (
    <div className='flex-1'>
      ...
      <div className='text-black flex flex-wrap justify-center p-4'>
        ...
        <div className='flex flex-col md:flex-row p-9 shadow-xl bg-blue-500  border-stone-200 rounded-md m-4'>
        ...
        <div className='flex flex-col md:flex-row-reverse p-9 md:text-right  shadow-xl bg-blue-500 border-stone-200 rounded-md m-4'>
          <div className='md:w-2/4'>
            <img src={image} className='w-auto rounded-md' />
          </div>
